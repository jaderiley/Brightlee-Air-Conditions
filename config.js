...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Brightlee Air-conditions",
    phone:     "+27 67 704 1163",
    whatsapp:  "+27 67 704 1163",
    address:   "33 Boundary Rd, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Brightlee Air-conditions — Aircon & hvac in randburg",
    description: "Brightlee Air-conditions provides professional aircon & HVAC in Randburg. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Aircon & HVAC · Randburg & surrounds",
    heroTitle:  "Stay cool, stay comfortable — <em>aircon done right.</em>",
    heroLead:   "Brightlee Air-conditions installs, repairs and services air conditioning and HVAC systems for homes and businesses across Randburg and the surrounding suburbs.",
    ...
    band: {
      ...
      alt:   "Brightlee Air-conditions team at work in Randburg",
      text:  "Keep your home or office comfortable all year round."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Randburg. Serving the surrounding area.",
    areasLead:  "We cover Randburg, Northcliff, Cresta and the wider region for installations, repairs and servicing.",
